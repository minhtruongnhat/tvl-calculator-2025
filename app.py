...
# Đặt Seed để đảm bảo tính ngẫu nhiên ổn định trên Streamlit
random.seed(42)
...
# ==================== GOOGLE SHEETS – SỬA LỖI SCOPE VÀ CACHE ====================
@st.cache_data(ttl=3600)
def lay_phan_tram_tu_sheets():
    try:
        # SỬA LỖI SCOPE: Dùng scope hiện đại hơn
...
# ==================== GIÁ XĂNG TỰ ĐỘNG – SỬA LỖI SCRAPER ====================
        ...
        for row in soup.find_all('tr'):
            if 'RON95' in row.get_text():
                ...
                if len(cells) >= 2:
                    ...
                    price_clean = price_raw.replace('.', '').replace(',', '').replace('đ', '').strip()
...
# ==================== TÍNH TOÁN TVL (ĐÃ SỬA LỖI LẠM PHÁT & LOGIC) ====================

# 1. Tính Chi phí Thực phẩm (Có Lạm phát)
...
# 6. Chi phí Quần áo (Phần trăm trên Chi phí Cơ bản Tùy nghi)
